...
public class ChickenNuggets extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "ChickenNuggets";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "AIR FRYER CHICKEN NUGGETS")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("AIR FRYER CHICKEN NUGGETS");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(ChickenNuggets.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_chicken_nuggets, menu);
        return true;
    }
