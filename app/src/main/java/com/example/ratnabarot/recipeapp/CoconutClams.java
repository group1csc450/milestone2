...
public class CoconutClams extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "CoconutClams";
    View mParentLayout;
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("COCONUT BROTH CLAMS WITH LEMONGRASS");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(CoconutClams.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_coconut_clams, menu);
        return true;
    }
