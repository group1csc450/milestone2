...
public class BlueberryOatmeal extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "BlueberryOatmeal";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blueberry_oatmeal);
        ...
        textView = findViewById(R.id.blueberry_oatmeal);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "BLUEBERRY BANANA OATMEAL SMOOTHIE")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("BLUEBERRY BANANA OATMEAL SMOOTHIE");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(BlueberryOatmeal.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_blueberry_oatmeal, menu);
        return true;
    }
