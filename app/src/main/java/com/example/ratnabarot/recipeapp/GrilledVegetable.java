...
public class GrilledVegetable extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "GrilledVegetable";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "GRILLED VEGETABLE PLATTER WITH YOGURT MINT SAUCE")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("GRILLED VEGETABLE PLATTER WITH YOGURT MINT SAUCE");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(GrilledVegetable.this, Login.class);
