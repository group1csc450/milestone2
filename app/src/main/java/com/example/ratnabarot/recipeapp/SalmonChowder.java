...
public class SalmonChowder extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "SalmonChowder";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salmon_chowder);
        ...
        textView = findViewById(R.id.salmon_chowder);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "SEATTLE SMOKED SALMON CHOWDER")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("SEATTLE SMOKED SALMON CHOWDER");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(SalmonChowder.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_salmon_chowder, menu);
        return true;
    }
