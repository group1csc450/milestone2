...
public class SteelCutOats extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "SteelCutOats";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_steel_cut_oats);
        ...
        textView = findViewById(R.id.steel_cut_oats);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "INSTANT POT STEEL CUT OATS")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("INSTANT POT STEEL CUT OATS");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(SteelCutOats.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_steel_cut_oats, menu);
        return true;
    }
