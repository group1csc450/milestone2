...
public class ChickpeaTomatoRosemary extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "ChickpeaTomatoRosemary";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chickpea_tomato_rosemary);
        ...
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "CHICKPEA TOMATO SOUP WITH ROSEMARY")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("CHICKPEA TOMATO SOUP WITH ROSEMARY");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(ChickpeaTomatoRosemary.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_chickpea_tomato_rosemary, menu);
        return true;
    }
