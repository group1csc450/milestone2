...
public class PeachArugula extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "PeachArugula";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peach_arugula);
        ...
        textView = findViewById(R.id.peach_arugula);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "PEACH ARUGULA SALAD")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("PEACH ARUGULA SALAD");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(PeachArugula.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_peach_arugula, menu);
        return true;
    }
