...
public class GreenDetox extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "GreenDetox";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_detox);
        ...
        textView = findViewById(R.id.green_detox);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "GREEN DETOX SOUP WITH TOASTED HEMP GREMOLATA")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("GREEN DETOX SOUP WITH TOASTED HEMP GREMOLATA");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(GreenDetox.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_green_detox, menu);
        return true;
    }
