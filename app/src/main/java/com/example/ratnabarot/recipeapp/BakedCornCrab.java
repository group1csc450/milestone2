...
public class BakedCornCrab extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "BakedCornCrab";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baked_corn_crab);
        ...
        textView = findViewById(R.id.Baked_Corn_Crab);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "BAKED CORN AND CRAB CAKES")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("BAKED CORN AND CRAB CAKES");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(BakedCornCrab.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_baked_corn_crab, menu);
        return true;
    }
