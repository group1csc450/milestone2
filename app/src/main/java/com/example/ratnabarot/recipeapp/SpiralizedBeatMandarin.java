...
public class SpiralizedBeatMandarin extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "SpiralizedBeatMandarin";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.beet_mandarin);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "RAW SPIRALIZED BEET & MANDARIN SALAD WITH MINT")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("RAW SPIRALIZED BEET & MANDARIN SALAD WITH MINT");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(SpiralizedBeatMandarin.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_spiralized_beat_mandarin, menu);
        return true;
    }
