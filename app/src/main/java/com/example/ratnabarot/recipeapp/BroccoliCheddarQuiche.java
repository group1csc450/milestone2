...
public class BroccoliCheddarQuiche extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "BroccoliCheddarQuiche";
    View mParentLayout;
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("CRUSTLESS BROCCOLI & CHEDDAR QUICHE");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(BroccoliCheddarQuiche.this, Login.class);
