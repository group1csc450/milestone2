...
public class CoconutPie extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "CoconutPie";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.coconut_pie);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "COCONUT OBSESSED PIE")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("COCONUT OBSESSED PIE");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(CoconutPie.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_coconut_pie, menu);
        return true;
    }
