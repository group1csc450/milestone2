...
public class CoconutMacaroonNests extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "CoconutMacaroonNests";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coconut_macaroon_nests);
        ...
        textView = findViewById(R.id.coconut_macaroon);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "COCONUT MACAROON NESTS")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("COCONUT MACAROON NESTS");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(CoconutMacaroonNests.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_coconut_macaroon_nests, menu);
        return true;
    }
