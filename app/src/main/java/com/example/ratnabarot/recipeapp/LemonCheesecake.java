...
public class LemonCheesecake extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "LemonCheesecake";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lemon_cheesecake);
        ...
        textView = findViewById(R.id.lemon_cheesecake);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "LEMON CHEESECAKE YOGURT CUPS")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("LEMON CHEESECAKE YOGURT CUPS");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(LemonCheesecake.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_lemon_cheesecake, menu);
        return true;
    }
