...
public class SummerMango extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "SummberMango";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summer_mango);
        ...
        textView = findViewById(R.id.summer_mango);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "SUMMER MANGO STONE FRUIT SMOOTHIE")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("SUMMER MANGO STONE FRUIT SMOOTHIE");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(SummerMango.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_summer_mango, menu);
        return true;
    }
