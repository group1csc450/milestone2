...
public class PinaBananaColada extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "PinaBananaColada";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pina_banana_colada);
        ...
        textView = findViewById(R.id.pina_colada);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "PIÑA BANANA COLADA SMOOTHIE")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("PIÑA BANANA COLADA SMOOTHIE");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(PinaBananaColada.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_pina_banana_colada, menu);
        return true;
    }
