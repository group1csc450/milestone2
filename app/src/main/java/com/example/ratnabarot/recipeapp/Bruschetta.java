...
public class Bruschetta extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "Bruschetta";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.bruschetta);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "BRUSCHETTA WITH TOMATO AND BASIL")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("BRUSCHETTA WITH TOMATO AND BASIL");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(Bruschetta.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_bruschetta, menu);
        return true;
    }
