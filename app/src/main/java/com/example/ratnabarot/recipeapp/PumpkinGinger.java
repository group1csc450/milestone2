...
public class PumpkinGinger extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "PumpkinGinger";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pumpkin_ginger);
        ...
        textView = findViewById(R.id.pumpkin_ginger);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "CREAMY PUMPKIN GINGER SOUP")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("CREAMY PUMPKIN GINGER SOUP");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(PumpkinGinger.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_pumpkin_ginger, menu);
        return true;
    }
