...
public class TropicalPapayaBatido extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "TropicalPapayaBatido";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tropical_papaya_batido);
        ...
        textView = findViewById(R.id.tropical_papaya);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "TROPICAL PAPAYA BATIDO FRUIT SHAKE")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("TROPICAL PAPAYA BATIDO FRUIT SHAKE");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(TropicalPapayaBatido.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tropical_papaya_batido, menu);
        return true;
    }
