...
public class BlackBeanQuinoa extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "BlackBeanQuinoa";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_black_bean_quinoa);
        ...
        textView = findViewById(R.id.black_bean_quinoa);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "SOUTHWESTERN BLACK BEAN, QUINOA AND MANGO SALAD")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("SOUTHWESTERN BLACK BEAN, QUINOA AND MANGO SALAD");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(BlackBeanQuinoa.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_black_bean_quinoa, menu);
        return true;
    }
