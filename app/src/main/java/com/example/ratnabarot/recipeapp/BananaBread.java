...
public class BananaBread extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "BananaBread";
    View mParentLayout;
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("BANANA NUT BREAD");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(BananaBread.this, Login.class);
