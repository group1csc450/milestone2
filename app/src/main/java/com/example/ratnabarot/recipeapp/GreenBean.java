...
public class GreenBean extends AppCompatActivity implements
    ...
    private static final String TAG = "GreenBean";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.green_bean);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "GREEN BEAN SALAD")
                .get()
        ...
        public void createNewComment(String content) {
            ...
            comment.setRecipeName("GREEN BEAN SALAD");
            ...
            mAuthListener = new FirebaseAuth.AuthStateListener() {
                ...
                public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                    ...
                    if (user != null) {
                        ...
                        Intent intent = new Intent(GreenBean.this, Login.class);
