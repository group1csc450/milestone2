...
public class BananaCacaoGreen extends AppCompatActivity implements
    ...
    private static final String TAG = "BananaCacaoGreen";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banana_cacao_green);
        ...
        textView = findViewById(R.id.banana_cacao);
                ...
                mAuthListener = new FirebaseAuth.AuthStateListener() {
                    ...
                    public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                        ...
                        if (user != null) {
                            ...
                            Intent intent = new Intent(BananaCacaoGreen.this, Login.class);
