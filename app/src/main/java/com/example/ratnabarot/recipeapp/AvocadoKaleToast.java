...
public class AvocadoKaleToast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent login = new Intent (AvocadoKaleToast.this, MainActivity.class);
                startActivity(login);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_avocado_kale_toast, menu);
        return true;
    }
