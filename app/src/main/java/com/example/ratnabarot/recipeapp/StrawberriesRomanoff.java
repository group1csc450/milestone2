...
public class StrawberriesRomanoff extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "StrawberriesRomanoff";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strawberries_romanoff);
        ...
        textView = findViewById(R.id.strawberries_romanoff);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "STRAWBERRIES ROMANOFF")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("STRAWBERRIES ROMANOFF");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(StrawberriesRomanoff.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_strawberries_romanoff, menu);
        return true;
    }
