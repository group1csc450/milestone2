...
public class SweetPotatoTots extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "SweetPotatoTots";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sweet_potato_tots);
        ...
        textView = findViewById(R.id.sweet_potato_tots);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "SWEET POTATO AND CARROT TOTS")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("SWEET POTATO AND CARROT TOTS");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(SweetPotatoTots.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_sweet_potato_tots, menu);
        return true;
    }
