...
public class StrawberrySquares extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "StrawberrySquares";
    View mParentLayout;
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("STRAWBERRY SQUARES");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(StrawberrySquares.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_strawberry_squares, menu);
        return true;
    }
