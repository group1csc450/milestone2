...
public class Chickpea extends AppCompatActivity implements
        ...
        IMainActivity
{
    ...
    private static final String TAG = "Chickpea";
    View mParentLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chickpea);
        ...
        textView = findViewById(R.id.chickpea_salad);

        //receive data
        fStore.collection("ingredients")
                .whereEqualTo("recipeName", "CHICKPEA SALAD")
                .get()
    ...
    public void createNewComment(String content) {
        ...
        comment.setRecipeName("CHICKPEA SALAD");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent intent = new Intent(Chickpea.this, Login.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_chickpea, menu);
        return true;
    }
